...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_vins_VinsJNI_onImageAvailable(JNIEnv *env,
                                               jobject type,
                                                                             jint width,
                                                                             jint height,
                                                                             jint rowStrideY,
...
//    env->ReleaseByteArrayElements(byteArray,srcLumaPtr,0);
    ...
    if (!isGetData) {
        ...
        cv::Mat saveImg(height,width,CV_8UC1);
        saveImg = mYuv(cv::Range(0,height),cv::Range(0,width));
        //cv::rotate(saveImg,saveImg,cv::ROTATE_90_CLOCKWISE);
        std::ostringstream oss;
        oss << path << img_time << ".png";
        cv::imwrite(oss.str(), saveImg);
    }
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_vins_VinsJNI_onPause(JNIEnv *env, jobject type) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_vins_VinsJNI_updateViewInfo(JNIEnv *env, jobject type,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_vins_VinsJNI_onARSwitch(JNIEnv *env, jobject type,
                                                                       jboolean isChecked) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_vins_VinsJNI_onLoopSwitch(JNIEnv *env, jobject type,
                                                                         jboolean isChecked) {
